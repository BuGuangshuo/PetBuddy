...
export interface PetBuddyApi {
  ...
  appearanceScenes: {
    uploadCustomGif(appearanceId: PetAppearanceId, scene: PetSceneKey): Promise<SettingsPayload>
    clearCustomGif(appearanceId: PetAppearanceId, scene: PetSceneKey): Promise<SettingsPayload>
  }
  pet: {
